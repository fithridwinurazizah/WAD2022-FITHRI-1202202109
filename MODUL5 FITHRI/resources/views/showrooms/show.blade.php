    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="mb-3">
          ...
          <input type="text" id="nama_mobil" class="form-control" name="nama_mobil" placeholder="{{ $showroom->name }}" disabled/>
        </div>
        <div class="mb-3">
          <label for="nama_pemilik" class="form-label">Nama Pemilik</label>
          <input type="text" id="nama_pemilik" class="form-control" name="nama_pemilik" placeholder="{{ $showroom->owner }}"disabled/>
        </div>
        <div class="mb-3">
          <label for="merk" class="form-label">Merk</label>
          <input type="text" id="merk" class="form-control" name="merk" placeholder="{{ $showroom->brand }}"disabled/>
        </div>
        <div class="mb-3">
          <label for="tanggal" class="form-label">Tanggal Beli</label>
          <input type="date" id="tanggal" class="form-control" name="tanggal" value="{{ $showroom->purchase_date }}"disabled/>
        </div>
        <div class="mb-3">
          ...
          <textarea
            ...
            id="deskripsi"
            class="form-control"
            placeholder="{{ $showroom->description }}" disabled
          ></textarea>
          <div class="mb-3 mt-3">
            <label for="foto" class="form-label">Foto</label>
            <div class='d-flex detail'>
              <button class='btn btn-secondary'>Choose File</button>
              <input type="text" name="foto" id="foto" class="form-control" value="{{ $showroom->image}}" disabled/>
            </div>
          </div>
          ...
          <a href="{{ route('showrooms.edit', $showroom->id)}}" class="btn btn-primary">Edit</a>
        </div>
      </div>
    </div>
</main>
